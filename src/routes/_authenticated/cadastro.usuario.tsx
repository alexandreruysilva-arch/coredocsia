    ...
    <div className="p-6 md:p-8 max-w-6xl mx-auto">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-border bg-gradient-to-br from-slate-900/10 via-blue-900/10 to-sky-700/10 p-6 md:p-8 mb-6">
        ...
        <div className="relative flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          ...
          <Button onClick={openCreate} size="lg" className="bg-gradient-to-r from-teal-500 via-cyan-500 to-sky-500 hover:from-teal-600 hover:via-cyan-600 hover:to-sky-600 text-white border-0 shadow-lg shadow-blue-800/30">
